# Generated by Django 2.0.7 on 2019-03-06 13:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flag', models.CharField(default=None, help_text='Flag is used with template tag check_role to restrict access in templates.', max_length=255, unique=True, verbose_name='Flag')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('roles', models.ManyToManyField(help_text='Select the groups (roles) with view access if access type = By role.', related_name='view_access', to='auth.Group', verbose_name='Roles')),
            ],
            options={
